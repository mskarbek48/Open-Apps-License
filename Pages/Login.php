              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  <span class="app-brand-logo demo">
                    <img src="<?=URL?>/assets/img/logo.png" style="width: 64px">
                  </span>
                  <span class="app-brand-text demo text-body fw-bolder" style="text-transform: none;">Open-Apps</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Witamy w Open-Apps! 👋</h4>
              <p class="mb-4">Proszę zaloguj się na swoje konto.</p>
      ...
      $.ajax({
          ...
          success: function(data)
          {
            ...
            if(data.success) {
              ...
              setTimeout(function(){
                window.location.href = '<?=URL?>/Licenses';
              }, 1000);
            } else {
